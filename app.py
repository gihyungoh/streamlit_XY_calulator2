...
# --- Streamlit UI ---
st.set_page_config(page_title="🎯 타원 X,Y 예측기 (z 구간별)", layout="centered")

st.title("🎯 타원 넓이 기반 X, Y 예측기 (z 구간별 함수)")
st.write("직사각형 A×B의 70% 넓이를 가지는 타원의 X2, Y2를 계산한 후, z 구간에 따라 X, Y를 예측합니다.")
...
# --- z 구간 정보 ---
with st.expander("ℹ️ z 구간별 함수 정보"):
    st.write("z 구간별로 다른 다항식 함수 사용 → 정확도 향상")
